...
class NotificationService {
  ...
  Future<bool> init() async {
    ...
    // flutter_native_timezone plugin here to prevent build issues on some
    // environments; default to UTC if local timezone can't be determined.
    tzdata.initializeTimeZones();
    try {
      tz.setLocalLocation(tz.getLocation('UTC'));
    } catch (e) {
      print('NotificationService - timezone init fallback to UTC: $e');
    }
