...
class AppTheme {
  static ThemeData get light => ThemeData(
    ...
    textTheme: const TextTheme(
      bodyLarge: TextStyle(fontFamily: 'Rubik', color: Colors.black87),
      bodyMedium: TextStyle(fontFamily: 'Rubik', color: Colors.black87),
      bodySmall: TextStyle(fontFamily: 'Rubik', color: Colors.black87),
      titleLarge: TextStyle(fontFamily: 'Rubik', color: Colors.black87),
      titleMedium: TextStyle(fontFamily: 'Rubik', color: Colors.black87),
      titleSmall: TextStyle(fontFamily: 'Rubik', color: Colors.black87),
      labelLarge: TextStyle(fontFamily: 'Rubik', color: Colors.black87),
      labelMedium: TextStyle(fontFamily: 'Rubik', color: Colors.black87),
      labelSmall: TextStyle(fontFamily: 'Rubik', color: Colors.black87),
    ),
  );
